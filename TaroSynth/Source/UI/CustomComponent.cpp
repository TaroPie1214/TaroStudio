...
SliderWithLabel::SliderWithLabel (juce::String labelName, juce::String paramId, juce::AudioProcessorValueTreeState& apvts, const int width, const int height, juce::Colour colour, SliderStyle style)
{
    sliderWidth = width;
    sliderHeight = height;
